...
rainy_days_trail_avg = daily_trail_avg[daily_rain_avg > 0].mean()
non_rainy_days_trail_avg = daily_trail_avg[daily_rain_avg == 0].mean()
...
plt.bar(labels, trail_avgs, color=['blue', 'green'])
plt.title('Average Subway Trail Users on Rainy vs. Non-Rainy Days')
plt.xlabel('Weather Condition')
plt.ylabel('Average Trail Users')
plt.show()
